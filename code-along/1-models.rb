...
values = { name: "Apple.Inc.",url: "hettps://apple.com", city: "Cupertino", state:"CA"}

apple = Company.new(values)
apple.save
puts "There are now #{Company.all.count} companies."

values = { name: "Amazon.com, Inc.", url: "hettps://amazon.com", city: "Seattle", state:"WA"}
...
california_company_slogan = "Think different."
...
new_company.url = "hettps://tesla.com"
